...
def test_and_plot_four_sum():
	# Sizes and timings
	sizes = list(range(10,400, 20))  # Interval of 200
	optimized_times = []
	brute_force_times = []
	...
	for size in sizes:
		...
		print(f"Size: {size}, Optimized time: {optimized_times[-1]}, Brute Force time: {brute_force_times[-1]}")
	# Plotting
...
def read_file_on_one_line(file):
	with open(file, 'r') as f:
		first_line = f.readline()
		arr = [int(i) for i in first_line.split()]
	return arr
...
'''
arr = read_file_on_one_line('/Users/huynguyen/Developer/2025/Weber-Spring/CS6420/Assignment/A1/Assignment 1 Files/200ints.txt')
arr = read_file('/Users/huynguyen/Developer/2025/Weber-Spring/CS6420/Assignment/A1/Assignment 1 Files/5Hints.txt')
...
print(f"Optimized: {num_pairs_optimized}, Brute Force: {num_pairs_brute_force}, Optimized Time: {opt_time}, Brute Force Time: {brute_time}")'''